...
public class SteamManager : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		try
		{
			AppId_t unOwnAppID = default(AppId_t);
			unOwnAppID.m_AppId = 871430u;
		...
		try
		{
			AppId_t unOwnAppID2 = default(AppId_t);
			unOwnAppID2.m_AppId = 979120u;
			if (SteamAPI.RestartAppIfNecessary(unOwnAppID2))
			{
				Application.Quit();
				return;
			}
