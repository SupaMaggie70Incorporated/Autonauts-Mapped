...
public class HatMod : Hat
{
	public override void Restart()
	{
		...
		if (ModManager.Instance.ModHatClass.GetModelRotation(m_TypeIdentifier, out var Rot))
		{
			m_ModelRoot.transform.localRotation = Quaternion.Euler(Rot.x, Rot.y, Rot.z);
		}
		if (ModManager.Instance.ModHatClass.GetModelTranslation(m_TypeIdentifier, out var Trans))
		{
