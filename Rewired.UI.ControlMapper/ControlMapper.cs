...
public class ControlMapper : MonoBehaviour
{
	private abstract class GUIElement
	{
		...
		public readonly UnityEngine.UI.Selectable selectable;
		...
		public GUIElement(GameObject gameObject)
		{
			...
			selectable = gameObject.GetComponent<UnityEngine.UI.Selectable>();
			if (selectable == null)
			{
		...
		public GUIElement(UnityEngine.UI.Selectable selectable, Text label)
		{
			if (selectable == null)
			{
				Debug.LogError("Rewired Control Mapper: Selectable is null!");
	...
	private class References
	{
		...
		[SerializeField]
		private UnityEngine.UI.Selectable _defaultSelection;
		...
		public UnityEngine.UI.Selectable defaultSelection => _defaultSelection;
