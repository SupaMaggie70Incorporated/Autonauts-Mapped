...
public class ThemeSettings : ScriptableObject
{
	...
	{
		[SerializeField]
		protected UnityEngine.UI.Selectable.Transition _transition;
		...
		public UnityEngine.UI.Selectable.Transition transition => _transition;
		...
		public virtual void Apply(UnityEngine.UI.Selectable item)
		{
			UnityEngine.UI.Selectable.Transition transition = _transition;
	...
	private class SelectableSettings : SelectableSettings_Base
	{
		...
		public override void Apply(UnityEngine.UI.Selectable item)
		{
			if (!(item == null))
			{
				base.Apply(item);
	...
	{
		if (component as UnityEngine.UI.Selectable != null)
		{
			Apply(themeClass, (UnityEngine.UI.Selectable)component);
		}
	...
	private void Apply(string themeClass, UnityEngine.UI.Selectable item)
	{
		if (!(item == null))
		{
