...
{
	public static UnityEngine.UI.Selectable FindNextSelectable(UnityEngine.UI.Selectable selectable, Transform transform, Vector3 direction)
	{
		...
		IList<UnityEngine.UI.Selectable> allSelectables = UnityEngine.UI.Selectable.allSelectables;
		...
		UnityEngine.UI.Selectable selectable2 = null;
		UnityEngine.UI.Selectable selectable3 = null;
		Vector2 point = vector2 + vector * 999999f;
		for (int i = 0; i < count; i++)
		{
			UnityEngine.UI.Selectable selectable4 = allSelectables[i];
			if (selectable4 == selectable || selectable4 == null || selectable4.navigation.mode == Navigation.Mode.None || (!selectable4.IsInteractable() && !ReflectionTools.GetPrivateField<UnityEngine.UI.Selectable, bool>(selectable4, "m_GroupsAllowInteraction")))
			{
				continue;
			}
